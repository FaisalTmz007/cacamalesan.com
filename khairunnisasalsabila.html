...
<html lang="en">
	<head>
	  <title>Buang Malesnya Yaaa</title>
	  <meta charset="utf-8">
	...
	<body onload="init_auto()">
		...
		<script type="text/javascript">
			...
			function startTime() {
				...
				if (H<5){
					txt='Pagi Euyy, Sarapan Jan Telat Sama Mandi Jangan Lupa:)';
					...
					txt='Siaang Caaa, Janlupa Makan Sama Tidur Siang yaaa:)';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
					...
					txt='Malem Caaa Tidurnya Jangan Malem2 yaaa, Sweet Dream yaaa:)';
					if(txt != txt2 && !starting)
						document.getElementById("quote").innerHTML = txt;
					txt2=txt;
				}
			...
			const quotes = [
			  {
			    "quote": "Jangan lama - lama malesnya, cepet2 suruh pergi yaaa, aku kangen :)",
			    "source": "Luvyuuu :*"
			  },
			]
